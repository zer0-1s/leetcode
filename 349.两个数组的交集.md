...
int main()
{
    ...
    for(i=0; i<10; i++) {
        ...
        user->id = i;
        user->cookie = i*i;
        HASH_ADD_INT(users,id,user); /* id: name of key field */
...
```
<code> HASH_ADD_INT(users,id,user); /* id: name of key field */</code></br> <p>接口约定，id是key的变量名</p>
